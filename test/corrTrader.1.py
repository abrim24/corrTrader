...
class MultiagentSystem(object):
    ...
    def runAgents(self):
        ...
        self.findLeader(sectorPrices[highidx[0][0]][highidx[0][1]], sectorPrices[highidx[1][0]][highidx[1][1]], highcorrs[0])
    ...
    def printCorrs(self,sectors,sectorPrices,highcorrs,highpairs):
        ...
        for sec in sectors:
            ...
            plt.xticks([1,2],[self.startDate,self.endDate])
            plt.legend()
            plt.show()
            i+=1

    def findLeader(self,A=[],B=[],corrAB=0):
